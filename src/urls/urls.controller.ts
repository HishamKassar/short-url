...
export class UrlsController {
  ...
  @Post()
  @ApiOperation({ summary: 'Create short URL', description: 'Returns the new created short URL from any URL' })
  ...
  @Get(':shortUrl')
  @ApiOperation({ summary: 'Redirect from short URL to original URL', description: 'This API will automatlciy rediret the user to the original URL' })
  ...
  @Get()
  @ApiOperation({ summary: 'Get all URLs in the system', description: 'Returns all the URLs in the system with a statistics about each URL' })
  @ApiResponse({
    status: 200,
